...
static const int64_t COIN_YEAR_REWARD = 84 * CENT; // 84% per year
...
inline bool IsProtocolV3(int64_t nTime) { return TestNet() || nTime > 1614003906; }

inline int64_t FutureDriftV1(int64_t nTime) { return nTime + 10 * 60; }
inline int64_t FutureDriftV2(int64_t nTime) { return nTime + 2 * 60 * 60; }
inline int64_t FutureDrift(int64_t nTime, int nHeight) { return IsProtocolV2(nHeight) ? FutureDriftV2(nTime) : FutureDriftV1(nTime); }

inline unsigned int GetTargetSpacing(int nHeight) { return IsProtocolV2(nHeight) ? 180 : 180; }
...
static const uint64_t nMinDiskSpace = 82428800;
