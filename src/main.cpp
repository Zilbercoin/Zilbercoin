...
#if defined(NDEBUG)
# error "Zilbercoin cannot be compiled without assertions."
#endif
...
int nStakeMinConfirmations = 50; //50 confirmation
...
const string strMessageMagic = "Zilbercoin Signed Message:\n";
...
{
    int64_t nSubsidy = 5000 * COIN; // Zilbercoin last block 1000
...
static const int64_t nTargetTimespan = 15 * 60;
...
{
    RenameThread("zilbercoin-loadblk");
