...
public:
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "Zilbercoin - Debug window", Q_NULLPTR));
        label_9->setText(QApplication::translate("RPCConsole", "Zilbercoin Core", Q_NULLPTR));
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the Zilbercoin debug log file from the current data directory. This can take a few seconds for large log files.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the Zilbercoin-Qt help message to get a list with possible Zilbercoin command-line options.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        ...
        tabWidget->setTabText(tabWidget->indexOf(tab), QApplication::translate("RPCConsole", "&Network Traffic", Q_NULLPTR));
    } // retranslateUi
