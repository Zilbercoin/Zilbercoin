...
public:
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 ZBC"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 ZBC"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 ZBC"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 ZBC"));
        ...
        labelBalance->setText(QStringLiteral("123.456 ZBC"));
