...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_BitcoinAddressValidator_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_BitcoinAddressValidator_t qt_meta_stringdata_BitcoinAddressValidator = {
    {
QT_MOC_LITERAL(0, 0, 23) // "BitcoinAddressValidator"
...
QT_INIT_METAOBJECT const QMetaObject BitcoinAddressValidator::staticMetaObject = { {
    QMetaObject::SuperData::link<QValidator::staticMetaObject>(),
    qt_meta_stringdata_BitcoinAddressValidator.data,
...
void *BitcoinAddressValidator::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_BitcoinAddressValidator.stringdata0))
