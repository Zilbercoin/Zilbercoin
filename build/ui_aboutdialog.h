...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Zilbercoin", Q_NULLPTR));
        label->setText(QApplication::translate("AboutDialog", "<b>Zilbercoin</b> version", Q_NULLPTR));
...
"Copyright \302\251 2021 The Zilbercoin developers", Q_NULLPTR));
